...
Mikrocontrolle.elf: $(SRCDIR)/led.o $(SRCDIR)/timer0.o $(SRCDIR)/timer2.o $(SRCDIR)/lcd.o $(SRCDIR)/encoder.o $(SRCDIR)/spi.o $(SRCDIR)/rfm69c.o $(SRCDIR)/transceiver.o $(SRCDIR)/Mikrocontrolle.o
